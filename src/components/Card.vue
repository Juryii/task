    ...
    <div class="column" v-for="(column, index) in columns" :key="index">
      <div class="cardName">
        <div class="cardNameTitle" v-if="flagEditColumntitle !== index">
          <h3>{{ column.title }}</h3>
          <div>
            <i class="fas fa-pen" @click="flagEditColumntitle = index"></i>
            <i class="fas fa-times" @click="deleteElement('column', index)"></i>
          </div>
        </div>
        <div v-else>
      ...
      <div class="CardItem" v-for="(columnitem, key) in column.CardItems" :key="key">
        ...
        <div class="cardNameItem" v-else>
          ...
          <div>
            ...
            <i class="fas fa-times" @click="deleteElement('item', key, column)"></i>
          </div>
        </div>
      </div>
  ...
  methods: {
    ...
    deleteElement(name, elem, column = "") {
      if (name === "column") {
        ...
        const columnDel = this.columns.indexOf(column);
